...
namespace WebFirst.Api.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        private RoleManager m = new RoleManager();
        ...
        public bool Add([FromBody] Role data)
        {
        ...
        public int InsertReturnIdentity([FromBody] Role data)
        {
        ...
        public bool Update([FromBody] Role data)
        {
