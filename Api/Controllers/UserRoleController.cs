...
namespace WebFirst.Api.Controllers
{
    ...
    public class UserRoleController : ControllerBase
    {
        ...
        private UserRoleManager m = new UserRoleManager();
        ...
        public bool Add([FromBody] UserRole data)
        {
        ...
        public int InsertReturnIdentity([FromBody] UserRole data)
        {
        ...
        public bool Update([FromBody] UserRole data)
        {
