...
namespace WebFirst.Api.Controllers
{
    ...
    public class MaterialController : ControllerBase
    {
        ...
        private MaterialManager m = new MaterialManager();
        ...
        public bool Add([FromBody] Material data)
        {
        ...
        public int InsertReturnIdentity([FromBody] Material data)
        {
        ...
        public bool Update([FromBody] Material data)
        {
