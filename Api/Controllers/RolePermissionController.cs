...
namespace WebFirst.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class RolePermissionController : ControllerBase
    {
        ...
        private RolePermissionManager m = new RolePermissionManager();
        ...
        public bool Add([FromBody] RolePermission data)
        {
        ...
        public int InsertReturnIdentity([FromBody] RolePermission data)
        {
        ...
        public bool Update([FromBody] RolePermission data)
        {
